...
class MAAgent(parl.Agent):
    def __init__(self,
        ...
        self.memory_size = int(1e7)
        self.min_memory_size = 100000 # batch_size * args.max_episode_len    100000
